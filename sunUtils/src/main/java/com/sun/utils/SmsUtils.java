...
public class SmsUtils {
    ...
    static final String accessKeyId = "LTAIY0UoqsCDdEub";
    static final String accessKeySecret = "fQjZhrOH4GKr46X6jpeX67JXhi06lD";
    ...
    public static SendSmsResponse sendSms(String telephone, String code)
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("好好学习");
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_128565086");
